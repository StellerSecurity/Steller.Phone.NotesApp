...
export class AppSettingsPage implements OnInit {
  ...
  public notesAppPasswordChange() {
    ...
    console.log(this.getPasswordStrength());
  ...
  public deleteWholeAppStorage() {

    if(confirm("* IF YOU CLICK ON OK, ALL NOTES WILL BE DELETED FROM YOUR DEVICE ! IT CANT BE RESTORED !")) {
      localStorage.clear();
